...
return [
    ...
    'permissions' => [
        ...
        'assistant_manager' => ['reviews.view', 'overtime.own'],
        'sales_manager'   => ['cases.manage', 'staff.view', 'schedule.view', 'reports.view', 'leaves.manage', 'inter_branch.view', 'repairs.view', 'quotations.manage', 'customers.manage', 'business_calendar.manage', 'business_tracking.manage', 'engineering_tracking.view', 'finance.view', 'procurement.view', 'inventory.view', 'reviews.view', 'petty_cash.view', 'overtime.view', 'overtime.own'],
        'eng_manager'     => ['cases.view', 'staff_skills.manage', 'schedule.manage', 'reports.view', 'leaves.manage', 'inter_branch.manage', 'repairs.manage', 'quotations.view', 'customers.view', 'business_calendar.view', 'business_tracking.view', 'engineering_tracking.manage', 'finance.view', 'procurement.view', 'inventory.manage', 'reviews.view', 'petty_cash.view', 'overtime.manage'],
        'eng_deputy'      => ['cases.view', 'staff.view', 'schedule.manage', 'leaves.manage', 'inter_branch.view', 'repairs.view', 'engineering_tracking.view', 'reviews.view', 'overtime.view', 'overtime.own'],
        'engineer'        => ['cases.view', 'schedule.view', 'leaves.own', 'repairs.view', 'engineering_tracking.own', 'reviews.view', 'overtime.own'],
        'sales'           => ['cases.own', 'schedule.view', 'leaves.own', 'repairs.own', 'quotations.own', 'customers.own', 'business_calendar.manage', 'business_tracking.own', 'reviews.view', 'overtime.own'],
        'sales_assistant' => ['cases.assist', 'schedule.view', 'leaves.own', 'quotations.view', 'customers.view', 'business_calendar.view', 'business_tracking.view', 'reviews.view', 'overtime.own'],
        'admin_staff'       => ['cases.view', 'staff.view', 'schedule.view', 'payments.manage', 'leaves.view', 'inter_branch.manage', 'repairs.manage', 'quotations.view', 'customers.view', 'business_calendar.view', 'business_tracking.view', 'engineering_tracking.view', 'finance.manage', 'procurement.manage', 'inventory.manage', 'accounting.manage', 'reviews.manage', 'petty_cash.manage', 'overtime.own'],
        'accountant'        => ['cases.view', 'finance.manage', 'procurement.view', 'inventory.view', 'accounting.manage', 'reports.view', 'reviews.view', 'petty_cash.manage', 'overtime.own'],
        'warehouse'         => ['inventory.manage', 'procurement.view', 'products.view', 'reviews.view', 'overtime.own'],
        'purchaser'         => ['procurement.manage', 'procurement.view', 'inventory.view', 'products.view', 'approvals.view', 'customers.view', 'reviews.view', 'overtime.own'],
        'hq'                => ['cases.view', 'staff.view', 'schedule.view', 'reports.view', 'leaves.view', 'inter_branch.view', 'repairs.view', 'quotations.view', 'customers.view', 'business_calendar.view', 'business_tracking.view', 'engineering_tracking.view', 'finance.view', 'procurement.view', 'inventory.view', 'products.view', 'reviews.view', 'petty_cash.view', 'overtime.own'],
    ],

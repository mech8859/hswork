...
return [
    ...
    'permissions' => [
        ...
        'admin_staff'       => ['cases.view', 'staff.view', 'schedule.view', 'payments.manage', 'leaves.view', 'inter_branch.manage', 'repairs.manage', 'quotations.view', 'customers.view', 'business_calendar.view', 'business_tracking.view', 'engineering_tracking.view', 'finance.manage', 'procurement.manage', 'inventory.manage', 'accounting.manage', 'reviews.manage', 'tech_manuals.view', 'petty_cash.manage', 'overtime.own', 'attendance.manage'],
        'accountant'        => ['cases.view', 'finance.manage', 'procurement.view', 'inventory.view', 'accounting.manage', 'reports.view', 'reviews.view', 'tech_manuals.view', 'petty_cash.manage', 'overtime.own', 'attendance.view'],

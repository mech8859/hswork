...
$jsonPath = '/raid/vhost/hswork.com.tw/ragic_petty_cash_eastlock.json';
...
$ylBranchId = findBranch('東區電子鎖', $branchMap);
$sysRecords = $db->prepare("SELECT * FROM petty_cash WHERE branch_id = ? OR entry_number LIKE 'P9-%' ORDER BY id");

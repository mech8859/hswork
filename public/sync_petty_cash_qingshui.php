...
$jsonPath = '/raid/vhost/hswork.com.tw/ragic_petty_cash_qingshui.json';
...
$ylBranchId = findBranch('清水分公司', $branchMap);
$sysRecords = $db->prepare("SELECT * FROM petty_cash WHERE branch_id = ? OR entry_number LIKE 'P8-%' ORDER BY id");

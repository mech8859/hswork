...
class CaseModel
{
    ...
    public function update(int $id, array $data): void
    {
        ...
        $stmt->execute([
            ...
            !empty($data['tax_amount']) ? str_replace(',', '', $data['tax_amount']) : null,
            !empty($data['total_amount']) ? str_replace(',', '', $data['total_amount']) : null,
            !empty($data['deposit_amount']) ? $data['deposit_amount'] : null,
            !empty($data['deposit_payment_date']) ? $data['deposit_payment_date'] : null,
            !empty($data['deposit_method']) ? $data['deposit_method'] : null,
            !empty($data['balance_amount']) ? str_replace(',', '', $data['balance_amount']) : null,

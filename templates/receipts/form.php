...
<div class="d-flex justify-between align-center flex-wrap gap-1 mb-2">
    ...
    <div class="d-flex gap-1">
        <?php if ($isEdit): ?>
            <?php if (!empty($prevId)): ?>
            <a href="/receipts.php?action=edit&id=<?= (int)$prevId ?>" class="btn btn-outline btn-sm" title="上一筆">&laquo; 上一筆</a>
            <?php else: ?>
            <span class="btn btn-outline btn-sm" style="opacity:.4;cursor:not-allowed">&laquo; 上一筆</span>
            <?php endif; ?>
            <?php if (!empty($nextId)): ?>
            <a href="/receipts.php?action=edit&id=<?= (int)$nextId ?>" class="btn btn-outline btn-sm" title="下一筆">下一筆 &raquo;</a>
            <?php else: ?>
